...
const taskController = {
  ...
  createTask: async (req, res) => {
    try {
      const { title, description, priority, label, team, date, team_code, deadline, subTasks, dependencies } = req.body;
...
if (assignedToUserId !== adminUserId) {
  ...
  io.to(assignedToUserId.toString()).emit('newNotification', notification);
}
  },
